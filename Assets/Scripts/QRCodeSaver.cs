...
{
    public GameObject qrCodeImage; // qr code dar ui neshan dadeh beshe
    ...
    // debug ba ar 
    // moshkele save file dakhele sharer
    // decode hal shod (bug fix) -- bekhatere unity package ZXing bud
}
